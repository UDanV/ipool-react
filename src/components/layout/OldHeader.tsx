...
import OldMobileMenu from "./OldMobileMenu";
...
function OldHeader() {
  ...
  return (
    <>
      <OldMobileMenu onClose={toggleMenu} isOpen={isMenuOpen} />
      ...
      <header className="sticky top-0 z-40 bg-[#F9FAFD]/95 pt-0 lg:pt-5.5 backdrop-blur-sm">
        ...
        >
          ...
          <div className="hidden lg:flex flex-1 justify-center">
            <ul className="flex font-semibold uppercase items-center gap-3 xl:gap-6 2xl:gap-11 text-[#2E2E2E] text-[clamp(0.78rem,0.9vw,1.25rem)] whitespace-nowrap">
