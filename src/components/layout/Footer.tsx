  ...
  return (
    <div className="mt-24 sm:mt-32 lg:mt-48 2xl:mt-64">
      ...
      <div className="flex flex-col gap-2 w-full max-w-[90dvw] m-auto sm:flex-row sm:items-end sm:justify-between">
        <h2 className="text-[56px] sm:text-[66px] lg:text-[80px] xl:text-[120px] 2xl:text-[182px] text-[#2e2e2e] font-bold leading-none sm:-translate-x-2">
          IPOOL
        </h2>
        <a
          href="mailto:info@ipool.ru"
          className="sm:block hidden text-base lg:text-2xl xl:text-3xl 2xl:text-5xl xl:mb-10 2xl:mb-16 uppercase"
        >
          info@ipool.ru
        </a>
