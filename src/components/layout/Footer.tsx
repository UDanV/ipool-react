function Footer() {
  return (
    <div className="mt-24 sm:mt-32 lg:mt-48 2xl:mt-64">
      <div className="flex flex-col items-center gap-2 w-full max-w-[90dvw] m-auto sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-col items-center text-base lg:text-2xl xl:text-3xl sm:items-end sm:translate-x-2">
