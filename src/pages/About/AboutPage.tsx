                ...
                <div className="mt-10 grid items-start gap-12 lg:mt-14 lg:grid-cols-[minmax(0,44%)_minmax(0,1fr)] lg:gap-14 xl:gap-20">
                    ...
                    <div className="flex flex-col gap-6 sm:gap-7 lg:gap-8 lg:border-l lg:border-black/10 lg:pl-10 xl:pl-14">
                        ...
                        >
                            ...
                            <span className="text-[#687C96]">индивидуальный подход</span> к каждому
                            клиенту.
                        </motion.h2>
                        ...
                        >
                            "iPool" — это новое лицо компании, которая более 10 лет удерживает прочные позиции
                            на Ростовском рынке услуг по обустройству SPA-зоны (бассейны, сауны, бани, SPA).
                        </motion.p>
                        ...
                        >
                            Компания "iPool" сочетает в себе огромный опыт, европейские традиции и успешную
