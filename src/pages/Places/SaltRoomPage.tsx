...
import saltIcon from '@/assets/salt-icon.svg'
...
const SaltRoomPage = () => {
    ...
    return (
        <>
            <HeroSectionSpa title="Соляная Комната" icon={saltIcon} ></HeroSectionSpa>
            <OfferSection title="Соляная Комната"></OfferSection>
